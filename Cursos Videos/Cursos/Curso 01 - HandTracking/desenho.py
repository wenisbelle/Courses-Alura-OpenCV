...
while True:
    ...
    if len(todas_maos) == 2:
        ...
        indicador_x1, indicador_y1, indicador_z1 = todas_maos[0]["coordenadas"][8]
        ...
        espessura_pincel = int(abs(indicador_z1)//3)
        cv2.circle(img, (indicador_x1,indicador_y1), espessura_pincel, cor_pincel, cv2.FILLED)

        if info_dedos_mao1 == DEDO_INDICADOR:
            if x_quadro == 0 and y_quadro == 0:
                x_quadro, y_quadro = indicador_x1, indicador_y1
            cv2.line(img_quadro, (x_quadro, y_quadro), (indicador_x1, indicador_y1), cor_pincel, espessura_pincel)
            x_quadro, y_quadro = indicador_x1, indicador_y1
        else:
            x_quadro, y_quadro = 0, 0
        
        img =cv2.addWeighted(img, 1.0, img_quadro, 0.2, 0)
